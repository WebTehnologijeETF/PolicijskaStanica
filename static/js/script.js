function posalji() {
    ...
    addNewEvent(document.forms["contactForm"]["ime"], 'blur', validateContactName);
    addNewEvent(document.forms["contactForm"]["email"], 'blur', validateContactEmail);
    addNewEvent(document.forms["contactForm"]["poruka"], 'blur', validateContactMsg);
};
